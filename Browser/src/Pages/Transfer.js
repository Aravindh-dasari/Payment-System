...
export  function Transfer() {
    ...
    const [message_real, setMessage_real] = useState("");
    ...
    const getAllMessages = () => {
        MessageService.getAllMessages()
            .then(response => {
                ...
                setMessage_real(response.data.messagecode)
            }).catch(error => {
                console.log(error);
            })
    }
            ...
            if (false && date == null) {
                ...
                // if (response.data.message) {
                    ...
                    const transaction = {
                        ...
                        "receiveraccountholdername": recName,
                        ...
                        <div className="box">
                            <form >
                                ...
                                <select id="message_code" className="form-select"
                                    value={message_real}
                                    onChange={(e) => {
                                        console.log("Message Code",e.target.value);
